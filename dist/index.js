...
var _excluded$O = ["onChange", "onKeyDown", "onClick"];
function PiIconInputForm(_ref) {
  ...
  var onFieldClick = function onFieldClick() {
    var input = document.getElementById(formField.name);
    setTimeout(function () {
      input.focus();
      input.select();
    }, 10);
...
function AtlasKitTemplate$P(_ref2) {
  ...
  var onFieldClick = function onFieldClick() {
    var input = document.getElementById(props === null || props === void 0 ? void 0 : props.name);
    setTimeout(function () {
      input.focus();
      input.select();
    }, 10);
...
var PiChartProps = /*#__PURE__*/function (_BaseProps) {
  _inheritsLoose(PiChartProps, _BaseProps);

  function PiChartProps() {
    return _BaseProps.apply(this, arguments) || this;
  }
...
function PiChart(props) {
  var newprops = new PiChartProps();
  return generateChartTemplate(_extends({}, newprops, props));
}
