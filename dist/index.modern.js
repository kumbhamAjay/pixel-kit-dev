...
function PiInput(props) {
  ...
  return generateInputTemplate({ ...newprops,
    ...props
  });
}
...
function PiInput2(props) {
  ...
  return generateInputTemplate$1({ ...newprops,
    ...props
  });
}
...
function PiButton(props) {
  ...
  return generateButtonTemplate({ ...newprops,
    ...props
  });
}
...
function PiTooltip(props) {
  ...
  return generateTooltipTemplate({ ...newprops,
    ...props
  });
}
...
function PiTimePicker(props) {
  ...
  return generateTimePickerTemplate({ ...newprops,
    ...props
  });
}
...
function PiTextArea(props) {
  ...
  return generateTextAreaTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$6({ ...props
}) {
...
function PiSpinner(props) {
  ...
  return generateSpinnerTemplate({ ...newprops,
    ...props
  });
}
...
function PiSelect(props) {
  ...
  return generateSelectTemplate({ ...newprops,
    ...props
  });
}
...
function PiRadioGroup(props) {
  ...
  return generateRadioGroupTemplate({ ...newProps,
    ...props
  });
}
...
function PiDateTimePicker(props) {
  ...
  return generateDateTimePickerTemplate({ ...newprops,
    ...props
  });
}
...
function PiDatePicker(props) {
  ...
  return generateDatePickerTemplate({ ...newProps,
    ...props
  });
}
...
function DefaultTemplate$7({ ...props
}) {
  const defaultProps = generateDefaultProps$5({ ...props
  });
...
function PiCheckbox(props) {
  ...
  return generateCheckboxTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$c({ ...props
}) {
  const theme = useContext(PiThemeContext);
  return React.createElement("div", {
...
function PiAvatar(props) {
  ...
  return generateAvatarTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$d({ ...props
}) {
  const theme = useContext(PiThemeContext);
  return React.createElement("div", {
...
function PiBreadCrumb(props) {
  ...
  return generateBreadCrumbTemplate({ ...newprops,
    ...props
  });
}
...
function PiTag(props) {
  ...
  return generateTagTemplate({ ...newprops,
    ...props
  });
}
...
function PiPagination(props) {
  ...
  return generatePaginationTemplate({ ...newprops,
    ...props
  });
}
...
function PiToggle(props) {
  ...
  return generateToggleTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$h({ ...props
}) {
  const theme = useContext(PiThemeContext);
...
function PiBanner(props) {
  ...
  return generateBannerTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$i({ ...props
}) {
...
function PiLozenge(props) {
  ...
  return generateLozengeTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$j({ ...props
}) {
...
function PiProgressIndicator(props) {
  ...
  return generateProgressIndicatorTemplate({ ...newprops,
    ...props
  });
}
...
function PiFlag(props) {
  ...
  return generateFlagTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$l({ ...props
}) {
  const theme = useContext(PiThemeContext);
  const appearance = props.appearance;
  return React.createElement("div", {
...
function PiSectionMessage(props) {
  ...
  return generateSectionMessageTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$m({ ...props
}) {
  return React.createElement("div", {
...
function PiPageHeader(props) {
  ...
  return generatePageHeaderTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$n({ ...props
}) {
...
function PiProfileSection(props) {
  ...
  return generateProfileTemplate({ ...newprops,
    ...props
  });
}
...
function PiSearch(props) {
  ...
  return generateSearchTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$p({ ...props
}) {
  const theme = useContext(PiThemeContext);
  const {
    navigate
...
function PiBackSection(props) {
  ...
  return generateBackTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$q({ ...props
}) {
  const theme = useContext(PiThemeContext);
...
function PiAttachments(props) {
  ...
  return generateAttachmentsTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$r({ ...props
}) {
  function deleteImage(file) {
    props.onClickDelete(file);
  }
...
function PiAttachmentList(props) {
  ...
  return generateAttachmentListTemplate({ ...newprops,
    ...props
  });
}
      ...
      action: () => {
        if (exportHandler.action) {
          ...
          if (exportHandler.method !== 'GET') {
            body['body'] = JSON.stringify({ ...exportHandler.body
            });
          }
...
const withGridStatic = WrapperComponent => ({ ...props
}) => {
  return React.createElement(WrapperComponent, Object.assign({}, props));
};

const withGridInfinite = WrapperComponent => ({ ...props
}) => {
...
const withGridPagination = WrapperComponent => ({ ...props
}) => {
  const onGridReady = params => {
    if (props.onGridReady) {
      props.onGridReady(params);
...
function PiGrid(props) {
  ...
  return generateGridTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$s(props) {
  const theme = useContext(PiThemeContext);
  const defaultProps = generateDefaultProps$6({ ...props
  });
  return React.createElement("div", {
...
function PiProductCard(props) {
  ...
  return generateProductCardTemplate({ ...newprops,
    ...props
  });
}
...
function PiActionIcon(props) {
  ...
  return generateActionIconTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$u({ ...props
}) {
  const theme = useContext(PiThemeContext);
...
function PiLabelName(props) {
  ...
  return generateLabelNameTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$v({ ...props
}) {
  const theme = useContext(PiThemeContext);
  return React.createElement("div", {
...
function PiQuoteName(props) {
  ...
  return generateQuoteNameTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$w({ ...props
}) {
...
function PiEditor(props) {
  ...
  return generateEditorTemplate({ ...newprops,
    ...props
  });
}
...
function PiPermissions(props) {
  ...
  if (permProps) {
    ...
    return generatePermissionsTemplate({ ...newprops,
      ...permProps
    });
  } else {
    return null;
...
function PiPermissionsList(props) {
  ...
  return generatePermissionsListTemplate({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$z({ ...props
}) {
  const theme = useContext(PiThemeContext);
  console.log(props);
  return React.createElement("div", {
...
function PiDropdownMenu(props) {
  ...
  return generateAddressTemplate({ ...newprops,
    ...props
  });
}
...
function getHeaderTemplate({ ...props
}) {
  const theme = useContext(PiThemeContext);
  console.log(props);
  return React.createElement("div", {
...
function PiHeaderMenu(props) {
  ...
  return generateHeaderMenuTemplate({ ...newprops,
    ...props
  });
}
...
function PiProfileHeader(props) {
  ...
  return generateProfileHeaderTemplate({ ...newprops,
    ...props
  });
}
...
function PiIconInputForm({
  ...
  const handleValueChange = e => {
    if (formField !== null && formField !== void 0 && formField.isAllowZero) {
      let {
        value
      } = e.target;
  ...
  const onFieldClick = () => {
    const input = document.getElementById(formField.name);
    setTimeout(() => {
      input.focus();
      input.select();
    }, 10);
  ...
  return React.createElement(Field, {
    ...
    maxLength: formField.maxLength,
    isMandatory: formField.isMandatory,
    isAllowZero: formField === null || formField === void 0 ? void 0 : formField.isAllowZero
...
function PiCheckBoxSelect(props) {
  ...
  return generateSelectTemplate$1({ ...newprops,
    ...props
  });
}
...
function PiCreateSelect(props) {
  ...
  return generateSelectTemplate$2({ ...newprops,
    ...props
  });
}
...
function PiBackSection$1(props) {
  ...
  return generateInvoiceTemplate({ ...newprops,
    ...props
  });
}
...
function PiAddress(props) {
  ...
  return generateAddressTemplate$1({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$F({ ...props
}) {
  const theme = useContext(PiThemeContext);
  return React.createElement("div", {
...
function PiIconDropdownMenu(props) {
  ...
  return generateAddressTemplate$2({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$G({ ...props
}) {
  const theme = useContext(PiThemeContext);
  return React.createElement("div", {
...
function PiIdComponent(props) {
  ...
  return generateIdComponentTemplate({ ...newprops,
    ...props
  });
}
...
function PiMultiAddress(props) {
  ...
  return generateAddressTemplate$3({ ...newprops,
    ...props
  });
}
...
function getHeaderTemplate$1({ ...props
}) {
  const theme = useContext(PiThemeContext);
  return React.createElement("div", {
...
function PiLeftMenu(props) {
  ...
  return generateHeaderMenuTemplate$1({ ...newprops,
    ...props
  });
}
...
function PiSideDrawer(props) {
  ...
  return generateSideDrawerTemplate({ ...newprops,
    ...props
  });
}
...
function PiFileUploader$1(props) {
  ...
  return generatefileUploaderComponentTemplate({ ...newprops,
    ...props
  });
}
...
function PiPasswordValidator$1(props) {
  ...
  return generatefileUploaderComponentTemplate$1({ ...newprops,
    ...props
  });
}
...
function PiServerGrid(props) {
  ...
  return generateGridTemplate$1({ ...newprops,
    ...props
  });
}
...
function PiUploader(props) {
  ...
  return generatefileUploaderComponentTemplate$2({ ...newprops,
    ...props
  });
}
...
function PiServerGrid2(props) {
  const newprops = new PiGridProps$2();
  return generateGridTemplate$2({ ...newprops,
    ...props
  });
}
...
function PiDateRangePicker(props) {
  ...
  return generateDateRangeTemplate({ ...newprops,
    ...props
  });
}
...
function PiConfirmModel(props) {
  ...
  return generateAddressTemplate$4({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$O({ ...props
}) {
  console.log(props);
  const theme = useContext(PiThemeContext);
...
function PiToast(props) {
  ...
  return generateAddressTemplate$5({ ...newprops,
    ...props
  });
}
...
function AtlasKitTemplate$P({
  ...
  const onFieldClick = () => {
    const input = document.getElementById(props === null || props === void 0 ? void 0 : props.name);
    setTimeout(() => {
      input.focus();
      input.select();
    }, 10);
...
function PiIconInput(props) {
  ...
  return generateInputTemplate$2({ ...newprops,
    ...props
  });
}
